...
def create_users(ctx, config):
    ...
    for client in config['clients']:
        ...
        ststests_conf['webidentity'].setdefault('token',os.environ['TOKEN'])
        ststests_conf['webidentity'].setdefault('aud',os.environ['AUD'])
        ststests_conf['webidentity'].setdefault('thumbprint',os.environ['THUMBPRINT'])
        ststests_conf['webidentity'].setdefault('KC_REALM',os.environ['KC_REALM'])
        ststests_conf['webidentity'].setdefault('KC_CLIENT',os.environ['KC_CLIENT'])
